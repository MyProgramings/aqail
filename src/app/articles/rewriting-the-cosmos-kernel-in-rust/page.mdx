...
export const article = {
  author: 'آدم واهان',
  date: '2022-07-14',
  title: 'إعادة كتابة نواة نظام التشغيل cosmOS بلغة Rust',
  description:
    'عندما أطلقنا الإصدار الأول من cosmOS العام الماضي، كان مكتوبًا بلغة Go. Go لغة برمجة رائعة، لكن لم أرَ منذ فترة طويلة مقالًا على الصفحة الرئيسية لموقع Hacker News يتحدث عن إعادة كتابة أداة مهمة بلغة Go، بينما أرى مقالات هناك تتحدث عن إعادة كتابة أشياء بلغة Rust كل أسبوع.',
}
