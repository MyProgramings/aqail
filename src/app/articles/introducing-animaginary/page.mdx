...
export const article = {
  author: 'آدم واهان',
  date: '2022-09-02',
  title: 'نقدم لكم Animaginary: رسوم متحركة عالية الأداء على الويب',
  description:
    'عندما تُنشئ موقعًا إلكترونيًا لشركة طموحة مثل بلانيتاريا، فأنت بحاجة إلى ترك انطباعٍ قوي. أردتُ أن يزور الناس موقعنا الإلكتروني ويشاهدوا رسومًا متحركة تبدو أكثر واقعية من الواقع نفسه.',
}
