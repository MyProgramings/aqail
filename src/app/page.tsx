  ...
  return (
    ...
    >
      <h2 className="flex text-sm font-semibold text-zinc-900 dark:text-zinc-100">
        ...
        <span className="mr-3">ابقَ على اطلاع دائم</span>
      </h2>
      <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
        احصل على إشعار عند نشر أي شيء جديد، ويمكنك إلغاء الاشتراك في أي وقت.
      </p>
      <div className="mt-6 flex">
        ...
        />
        <Button type="submit" className="mr-4 flex-none">
          انضم
        </Button>
      </div>
    </form>
  ...
  return (
    <li className="flex gap-4">
      ...
      <dl className="flex flex-auto flex-wrap gap-x-2">
        ...
        <dd
          className="mr-auto text-xs text-zinc-400 dark:text-zinc-500"
